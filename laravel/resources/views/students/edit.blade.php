            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-10">
                        <!-- BEGIN Card -->
                        <form id="edit-form" action="{{ route('management-students.edit', $student) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card mb-3">
                                <div class="card-header border-bottom-0">
                                    <h6 class="card-title mb-0">Sửa học sinh</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 order-2 order-md-1">
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ old('student_identification_code',$student->student_identification_code) }}"
                                                            ...
                                                            <select id="filter_class" class="form-select" name="class_id">
                                                                ...
                                                                @foreach ($classes as $class)
                                                                    <option value="{{ $class->id }}"
                                                                        @if (old('class_id', $student->class_id) == $class->id) selected @endif>
                                                                        {{ $class->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('class_id')
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ old('full_name', $student->full_name) }}" name="full_name"
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group custom-input-group">
                                                        <input type="text" class="form-control flex-grow-1"
                                                            value="{{ old('address', $student->address) }}" name="address"
                                                            placeholder="">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group custom-input-group">
                                                        <input type="text" class="form-control flex-grow-1"
                                                            value="{{ old('guardian_phone', $student->guardian_phone) }}" name="guardian_phone"
                                                            placeholder="+84">
                                                        <span class="input-group-text flex-shrink-0"><i
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ old('student_identification_code',$student->guardian_full_name) }}"
                                        ...
                                        <div class="col-md-3 pt-3 mx-auto order-1 order-md-2">
                                            <p class="text-center">
                                                <img src="{{ $student->student_face_url ? asset('images/' . $student->student_face_url) : asset('assets/img/media/avatar-default.png') }}"
                                ...
                                <div class="card-footer border-top-0 bg-transparent d-flex align-items-center">
                                    ...
                                    <button type="button" class="btn btn-warning px-4 ms-auto"
                                        data-bs-target="#modalConfirmEdit" data-bs-toggle="modal"
                                        id="btn-edit">Sửa</button>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-center">Bạn muốn sửa thông tin học sinh <strong>{{ $student->full_name }}</strong>
                        không?
                    </p>
                    <div class="text-center">
                        <button type="button" class="btn btn-outline-secondary mx-1" data-bs-dismiss="modal"
