...
class StudentCreateRequest extends FormRequest
{
    ...
    {   
        ...
        return [
            'student_identification_code' => ['required','regex:/^[a-zA-Z0-9_]{8,12}$/',Rule::unique($table, 'student_identification_code'),],
            'student_code' => ['required','regex:/^[a-zA-Z0-9_]{8,12}$/',Rule::unique($table, 'student_code'),],
